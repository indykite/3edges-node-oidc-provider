...
module.exports = (provider, { opaque }) => {
  ...
  return {
    ...
    async getValueAndPayload() {
      ...
      tokenPayload = aud ? { ...tokenPayload, aud } : tokenPayload
      ...
      const config = await getResourceServerConfig(structuredToken.payload);

      delete structuredToken.payload.resourceServer;
      delete structuredToken.payload.client;
